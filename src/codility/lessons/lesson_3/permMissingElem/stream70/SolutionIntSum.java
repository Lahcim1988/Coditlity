package codility.lessons.lesson_3.permMissingElem.stream70;

import java.util.ArrayList;
import java.util.List;

public class SolutionIntSum {
    ...
    public static void main(String[] args) {
        ...
        SolutionIntSum s = new SolutionIntSum();
    ...
    public int solution(int[] A) {
        ...
        Integer sum = integers.stream()
                .mapToInt(Integer::intValue)        // or (Integer::valueOf)
                .sum();
